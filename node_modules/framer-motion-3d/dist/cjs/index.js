...
function useTap(isStatic, _a, visualElement) {
    ...
    return {
        onPointerDown: framerMotion.wrapHandler(function (event, info) {
            ...
            cancelPointerEndListeners.current = popmotion.pipe(framerMotion.addPointerEvent(window, "pointerup", onPointerUp), framerMotion.addPointerEvent(window, "pointercancel", onPointerCancel));
...
var useIsomorphicLayoutEffect = framerMotion.isBrowser ? React.useLayoutEffect : React.useEffect;
...
function useForceUpdate() {
    ...
    framerMotion.useUnmountEffect(function () { return (isUnmountingRef.current = true); });
...
function CanvasComponent(_a, forwardedRef) {
    ...
    var _b = tslib.__read(useForceUpdate(), 1), forceRender = _b[0];
            ...
            React__namespace.createElement(React__namespace.Suspense, { fallback: React__namespace.createElement(Block, { set: setBlock }) },
                React__namespace.createElement(MotionCanvasContext.Provider, { value: {
                    ...
                    React__namespace.createElement(framerMotion.MotionConfigContext.Provider, { value: configContext },
                        React__namespace.createElement(framerMotion.MotionContext.Provider, { value: motionContext }, children))))), canvasRef.current, tslib.__assign(tslib.__assign({}, props), { dpr: dpr || props.dpr, size: size, events: events || fiber.events }));
    }
    useIsomorphicLayoutEffect(function () {
