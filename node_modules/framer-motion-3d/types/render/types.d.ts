...
import type { ResolvedValues, AnimationProps, TapHandlers, MotionValue, HoverHandlers, AnimationLifecycles } from "framer-motion";
...
export declare type AcceptMotionValues<T> = Omit<T, "position" | "scale" | "rotation" | "color"> & {
...
export declare type ThreeMotionComponents = {
    [K in keyof JSX.IntrinsicElements]: ForwardRefComponent<JSX.IntrinsicElements[K], ThreeMotionProps & Omit<AcceptMotionValues<JSX.IntrinsicElements[K]>, "onUpdate">>;
};
export {};
